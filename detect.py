...
def run(
        ...
        source=0,  # Source for inference (file, dir, URL, webcam, etc.)
            ...
            if len(det):
                ...
                for *xyxy, conf, cls in reversed(det):
                    ...
                    if( confidence <0.5 and (c == 0 or c == 1 or c ==2)):
                        continue
                    if(round(confidence) >=0.5 and (c == 0)):
                        print("Box")
                    if(round(confidence) >=0.5 and (c == 1)):
                        print("QR")
                    if(round(confidence) >=0.5 and (c ==2)):
                        print("DESTINATION")
...
weight_path = "C:\\Users\\pc\\Desktop\\codes\\yolov5\\yolov5-master\\last.pt"

if __name__ == '__main__':
    run(weights=weight_path, source=0)
